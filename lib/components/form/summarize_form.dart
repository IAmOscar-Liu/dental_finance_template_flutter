...
class SummarizeForm extends StatelessWidget {
  SummarizeForm({super.key});

  final List<List<String>> dentalInfo = [
    ["牙技所名稱", "福家牙技所"],
  ...
  final List<List<String>> contractInfo = [
    ["合約ID", "C-10001"],
    ["合約種類", "服務平台合約"],
    ["合約編號", "C-12345678"],
    ['合約名稱', "福家牙技所服務平台合約"],
  ...
  Widget build(BuildContext context) {
    if (dentalInfo.length % 2 == 1) dentalInfo.add(["", ""]);
    if (contractInfo.length % 2 == 1) contractInfo.add(["", ""]);
        ...
        children: [
          ...
          Container(
            ...
            child: Wrap(
              ...
              children: dentalInfo
                  .map((info) => ConstrainedBox(
                        constraints:
                            BoxConstraints(minWidth: 300, maxWidth: 400),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [Text(info[0]), Spacer(), Text(info[1])],
                        ),
                      ))
                  .toList(),
            ),
